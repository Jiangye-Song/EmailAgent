...
export const proxy = auth((req) => {
  ...
  const protectedRoutes = ["/inbox", "/settings", "/onboarding", "/opportunities", "/deals", "/todo"];
...
export const config = {
  ...
  matcher: ["/inbox/:path*", "/settings/:path*", "/onboarding/:path*", "/opportunities/:path*", "/deals/:path*", "/todo/:path*"],
};
